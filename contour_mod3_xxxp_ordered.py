...
X0=np.loadtxt("../seqb/dihedral_ree_local_rightP_at_4thpos.dat")
X1= np.loadtxt("../seqc_modify/dihedral_ree_local_rightP_at_4thpos.dat")
X2=np.loadtxt("../seqd/dihedral_ree_local_rightP_at_4thpos.dat")
X3=np.loadtxt("../seqe/dihedral_ree_local_leftP_at_1stpos.dat")
X4=np.loadtxt("../seqx/dihedral_ree_local_rightP_at_4thpos.dat")
X5=np.loadtxt("../seqy/dihedral_ree_local_rightP_at_4thpos.dat")
X6=np.loadtxt("../seqz/dihedral_ree_local_rightP_at_4thpos.dat")
###########################################################
mappables=[]
mappables1=[]
mappables2=[]
...
plt.savefig("xxxp_six_plots.png",bbox_inches = "tight", dpi=300 )
#plt.show()
plt.close()
...
plt.savefig("xxxp_ref_plots.png",bbox_inches = "tight", dpi=300 )
#plt.show()
plt.close()
